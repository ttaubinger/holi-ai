...
export interface Cron { cron_id: string; category?: string; frequency?: string; title: string; schedule: string; cron_expression?: string; description?: string; linked_module?: string; is_active: boolean; requires_logging?: boolean; log_type?: string; log_unit?: string; }
