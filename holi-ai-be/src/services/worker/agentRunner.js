...
const loadAgentContext = async (apiKeys, userId) => {
  ...
  if (prompt) {
    prompt += '\n\nCRITICAL RULE: You must default to using the metric system (kg, cm, liters) for all measurements, questions, and plans unless the user explicitly provides imperial units.';
  }
