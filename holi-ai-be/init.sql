...
CREATE INDEX IF NOT EXISTS idx_episodic_memory_user_id ON episodic_memory(user_id, created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_llm_job_queue_user_id ON llm_job_queue ((payload->>'userId'), created_at DESC);
...
CREATE INDEX IF NOT EXISTS idx_llm_traces_user_id ON llm_traces(user_id, created_at DESC);
